...
public class ActividadMujeres {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            System.out.print("Ingrese sexo de " + nombres[i] + " (mujer/hombre): ");
            sexos[i] = scanner.nextLine().toLowerCase(); // Convertir a minúsculas para comparación
        ...
        // Imprimir mujeres con edad por debajo del promedio
        System.out.println("\n===== MUJERES CON EDAD POR DEBAJO DE PROMEDIO =====");
        for (int i = 0; i < n; i++) {
            if (sexos[i].equals("mujer") && edades[i] < promedioEdad) {
                System.out.println("Cédula: " + cedulas[i] + ", Nombre: " + nombres[i] + ", Edad: " + edades[i]);
            }
        }
